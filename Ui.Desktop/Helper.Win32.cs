...
namespace Helper
{
    public class Win32
    {
        ...
        public delegate void HwndFoundEventHandler( int hwnd );
        public static event HwndFoundEventHandler HwndFoundEvent = null;
        ...
        #region AskHwndFromProcess()

        public static void AskHwndFromProcess( String processName )
        {
            s_processName = processName;

            EnumWindows( new EnumWindowsDelegate(EnumWindowsCallBackByProcessName2), 0 );
        }

        public static void AskHwndFromProcess( Process process )
        {
        ...
        public static void AskHtmlDocumentFromProcess( Process process )
        {
            s_process = process;
            ...
            EnumWindows( new EnumWindowsDelegate( EnumWindowsCallBackByProcess ), 0 );
        }
        ...
        private static bool EnumWindowsCallBackByProcessName( int hwnd, int lParam )
        {
            ...
            foreach( Process process in Process.GetProcessesByName( s_processName ) )
            {
                if( process.Id == (int) processId )
                {
                    ...
                    // return false;
                    // DO NOT RETURN FALSE, meaning let it continue for the case we hit the wrong window
                }
            }
        ...
        private static bool EnumWindowsCallBackByProcessName2( int hwnd, int lParam )
        {
            IntPtr windowHandle = (IntPtr) hwnd;
        ...
        private static bool EnumWindowsCallBackByProcess( int hwnd, int lParam )
        {
            IntPtr windowHandle = (IntPtr) hwnd;
